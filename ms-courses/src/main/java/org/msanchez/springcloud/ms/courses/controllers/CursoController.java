package org.msanchez.springcloud.ms.courses.controllers;
...
import org.msanchez.springcloud.ms.courses.services.CursoService;
...
public class CursoController {
  ...
  public ResponseEntity<?> editar(
      @Valid @RequestBody Curso curso, BindingResult result, @PathVariable Long id) {
    if (result.hasErrors()) {
      return validar(result);
    }
  ...
  public ResponseEntity<?> asignarUsuario(
      @RequestBody Usuario usuario, @PathVariable Long cursoId) {
    Optional<Usuario> o;
    try {
          ...
          .body(
              Collections.singletonMap(
                  ...
                  "No existe el usuario por "
                      + "el id o error en la comunicacion: "
                      + e.getMessage()));
    }
    if (o.isPresent()) {
